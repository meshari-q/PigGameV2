...
public class MainActivity extends AppCompatActivity {
    ...
    public void onResume() {
        ...
        }else{ game.setMaxScore(MAX_SCORE);}
        ...
        if(!savedValues.getBoolean("pref_backGround", false)) {
            ...
            } else{rLayout.setBackgroundResource(R.drawable.backg3);}
    ...
    protected void clickNewgame(View v){
        ...
        if(game.getSum2() > game.getSum2()){
            Toast.makeText(this, "player one wins",
                    Toast.LENGTH_LONG).show();
        }
        else if (game.getSum1() == game.getSum2()){
            Toast.makeText(this, "Tie",
                    Toast.LENGTH_LONG).show();
        }else {Toast.makeText(this, "player two wins",
                Toast.LENGTH_LONG).show();}
        game.resetGame();
    }
